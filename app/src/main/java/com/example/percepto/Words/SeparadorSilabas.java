...
public class SeparadorSilabas {
    ...
    public SeparadorSilabas(String x){
        cadena = x;
    }

    public SeparadorSilabas(){
        cadena = "";
    }

    public SeparadorSilabas(int ascii[]){
        char c;
        int i;
        cadena = "";
    ...
    public SeparadorSilabas(char c[]){
        int i;
        cadena = "";
